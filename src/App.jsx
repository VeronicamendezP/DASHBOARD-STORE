import { RiMenuLine, RiUser3Line, RiAddCircleLine, RiShoppingCart2Line, RiCloseLine, RiSearchEyeLine } from "react-icons/ri";
...
function App() {
  ...
  //funcion aparecer y desaparecer 
  const toggleMenu = () => {
  ...
  return (
    <div className='bg-[#262837] w-full min-h-screen'>
      ...
      {/* mobile menu responsive: lg:hidden */}
        ...
        <div className="lg:col-span-6">
          ...
          <header className="p-4">
            ...
            <div className="flex flex-col gap-4 mb-6">
              <div >
                <h1 className="text-2xl text-gray-300">Resto Jeager</h1>
                <p className="text-gray-500">15 Febrero 2024</p>
              </div>
              <form>
